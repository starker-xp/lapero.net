...
class BuzzExpertRender extends AbstractRender
{
    ...
    {
        $contenu = $this->remplacerLesCaracteresSpeciaux($this->contenu);
        return $contenu;
    }
    ...
    {
        // Gestion des accents.
        $findAccent = array('Â', 'â', 'Á', 'á', 'Ã', 'ã', 'Ᾱ', 'ᾱ', 'Ç', 'ç', 'Č', 'č', 'Ć', 'ć', 'Ê', 'ê', 'Ë', 'ë', 'Ė', 'ė', 'ï', 'Î', 'î', 'Í', 'í', 'ń', 'Ô', 'ô', 'Ó', 'ó', 'Õ', 'õ', 'Œ', 'œ', 'Ō', 'ō', 'Ś', 'ś', 'Š', 'š', 'Û', 'û', 'Ū', 'ū', 'Ӱ', 'ӱ');
        $replaceAccent = array('A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'C', 'c', 'C', 'c', 'C', 'c', 'E', 'e', 'E', 'e', 'E', 'e', 'i', 'I', 'i', 'I', 'i', 'n', 'O', 'o', 'O', 'o', 'O', 'o', 'oe', 'oe', 'O', 'o', 'S', 's', 'S', 's', 'U', 'u', 'U', 'u', 'Y', 'y');
